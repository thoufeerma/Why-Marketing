    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-[90] w-14 h-14 bg-noir-surface/90 backdrop-blur-md rounded-full flex items-center justify-center text-gold-primary hover:text-gold-light hover:bg-noir-card transition-colors shadow-2xl group"
