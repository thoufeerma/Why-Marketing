        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20 max-w-5xl mx-auto">
          {challenges.map((c, i) => (
            <FadeIn key={c.num} delay={i * 0.1}>
              <div 
                className="group relative flex flex-col h-full justify-start rounded-[28px] bg-noir-surface p-10 border border-[rgba(212,175,55,0.12)] transition-all duration-[300ms] ease-out hover:-translate-y-1 hover:shadow-xl hover:border-gold-primary/50 hover:bg-noir-surface"
              >
