        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {articles.map((article, index) => (
            <FadeIn key={index} delay={index * 0.1}>
              <Link 
                href="#"
                className="group flex items-center justify-between p-10 border border-border-white bg-transparent hover:bg-noir-surface hover:-translate-y-[2px] transition-all duration-300 shadow-none hover:shadow-xl hover:border-[rgba(212,175,55,0.3)] h-full"
              >
