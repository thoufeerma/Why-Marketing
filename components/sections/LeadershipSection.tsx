    ...
    <section id="leadership" className="py-24 md:py-32 bg-noir-surface relative w-full border-t border-border-white overflow-hidden">
      ...
      <AnimatePresence>
        {selectedCert && (
          ...
          >
            <button 
              className="absolute top-6 right-6 md:top-10 md:right-10 w-12 h-12 flex items-center justify-center rounded-full bg-noir-surface border border-border-white text-white hover:border-gold-primary hover:text-gold-primary transition-colors z-[110]"
