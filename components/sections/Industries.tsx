  ...
  return (
    <section className="py-24 md:py-32 min-h-0 md:min-h-[90svh] flex items-center bg-noir-surface relative border-t border-border-white w-full">
      <Container>
        ...
        {/* Content Panel */}
        <FadeIn delay={0.2} className="max-w-5xl mx-auto bg-noir-surface border border-[rgba(212,175,55,0.12)] rounded-[24px] p-6 md:p-10 lg:p-12 min-h-[280px] flex items-center relative overflow-hidden">
