    ...
    <section id="planner" className="py-24 md:py-32 min-h-0 md:min-h-[100svh] flex flex-col justify-center bg-noir-surface relative border-y border-border-white w-full overflow-hidden">
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-20 max-w-[1200px] mx-auto pb-10">
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            ...
                            isSelected 
                              ? "border-gold-primary bg-noir-surface -translate-y-1 shadow-lg" 
                              : "border-[rgba(212,175,55,0.12)] bg-noir-surface hover:border-gold-primary hover:bg-noir-surface hover:-translate-y-1"
                          )}
                        >
                          <span className={cn(
          ...
          <div className="bg-noir-surface border border-[rgba(212,175,55,0.12)] rounded-[28px] p-8 md:p-12 relative flex flex-col shadow-2xl h-full">
            <div className="mb-10">
                 ...
                 <div className="flex flex-wrap gap-3" key={selections.business}>
                   {strategy.services.length > 0 ? strategy.services.map((s, i) => (
                     <motion.div
                       ...
                       className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full border border-[rgba(212,175,55,0.15)] bg-noir-surface transition-colors hover:border-gold-primary hover:bg-noir-card"
                     >
                 ...
                 <div className="flex flex-wrap gap-2.5" key={selections.business + selections.goal}>
                   {strategy.focus.length > 0 ? strategy.focus.map((f, i) => (
                     <motion.span 
                        ...
                        transition={{ duration: 0.2, delay: i * 0.05 }}
                        className="inline-flex items-center px-4 py-2 rounded-full border border-border-white bg-noir-surface text-[13px] font-semibold tracking-wide text-noir-text-sec"
                     >
                       {f}
                     </motion.span>
                   )) : (
