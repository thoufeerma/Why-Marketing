    ...
    <section id="hero" className="relative min-h-0 py-24 md:py-32 md:min-h-[100svh] flex items-center overflow-hidden bg-noir-bg w-full">
      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-center">
          ...
          >
            {/* Free Audit Form */}
            <div className="w-full max-w-lg bg-[#111111]/80 backdrop-blur-xl border border-[rgba(212,175,55,0.12)] rounded-[24px] md:rounded-[32px] p-5 md:p-8 shadow-2xl relative overflow-hidden">
              {/* Subtle top glow */}
              ...
              <form className="space-y-3 md:space-y-4 mt-3 md:mt-4" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                  <div className="space-y-1">
                    ...
                    <input type="text" placeholder="Your full name" className="w-full bg-[#1a1a1a] border border-[rgba(212,175,55,0.15)] rounded-[10px] md:rounded-xl px-3 py-2 md:px-4 md:py-2.5 text-[13px] text-white placeholder:text-noir-muted/50 focus:border-gold-primary focus:ring-1 focus:ring-gold-primary outline-none transition-all" />
                  </div>
                  <div className="space-y-1">
                    <label className="text-[10px] md:text-[11px] font-bold tracking-wide uppercase text-noir-muted ml-1">Company / Business</label>
                    <input type="text" placeholder="Company name" className="w-full bg-[#1a1a1a] border border-[rgba(212,175,55,0.15)] rounded-[10px] md:rounded-xl px-3 py-2 md:px-4 md:py-2.5 text-[13px] text-white placeholder:text-noir-muted/50 focus:border-gold-primary focus:ring-1 focus:ring-gold-primary outline-none transition-all" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                  <div className="space-y-1">
                    ...
                    <input type="tel" placeholder="+1 (555) 000-0000" className="w-full bg-[#1a1a1a] border border-[rgba(212,175,55,0.15)] rounded-[10px] md:rounded-xl px-3 py-2 md:px-4 md:py-2.5 text-[13px] text-white placeholder:text-noir-muted/50 focus:border-gold-primary focus:ring-1 focus:ring-gold-primary outline-none transition-all" />
                  </div>
                  <div className="space-y-1">
                    <label className="text-[10px] md:text-[11px] font-bold tracking-wide uppercase text-noir-muted ml-1">Business Email</label>
                    <input type="email" placeholder="you@company.com" className="w-full bg-[#1a1a1a] border border-[rgba(212,175,55,0.15)] rounded-[10px] md:rounded-xl px-3 py-2 md:px-4 md:py-2.5 text-[13px] text-white placeholder:text-noir-muted/50 focus:border-gold-primary focus:ring-1 focus:ring-gold-primary outline-none transition-all" />
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <input type="url" placeholder="https://yourwebsite.com" className="w-full bg-[#1a1a1a] border border-[rgba(212,175,55,0.15)] rounded-[10px] md:rounded-xl px-3 py-2 md:px-4 md:py-2.5 text-[13px] text-white placeholder:text-noir-muted/50 focus:border-gold-primary focus:ring-1 focus:ring-gold-primary outline-none transition-all" />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <textarea rows={2} placeholder="Tell us about your SEO goals, challenges, or requirements..." className="w-full bg-[#1a1a1a] border border-[rgba(212,175,55,0.15)] rounded-[10px] md:rounded-xl px-3 py-2 md:px-4 md:py-2.5 text-[13px] text-white placeholder:text-noir-muted/50 focus:border-gold-primary focus:ring-1 focus:ring-gold-primary outline-none transition-all resize-none"></textarea>
                </div>
