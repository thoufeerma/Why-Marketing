        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {metrics.map((metric, index) => (
            <div 
              key={index} 
              className={cn(
                "group relative bg-[#111111] border border-[rgba(212,175,55,0.12)] rounded-[24px] p-10 flex flex-col items-center justify-center text-center transition-all duration-[250ms] ease-out hover:-translate-y-1 hover:border-gold-primary/40 hover:bg-[#171717] overflow-hidden",
