        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-[1200px] mx-auto pb-10 md:pb-0">
          {caseStudies.map((study, index) => (
            <FadeIn key={index} delay={index * 0.1}>
              <Link 
                href="#"
                className="group flex flex-col justify-between bg-[#111111] border border-[rgba(212,175,55,0.12)] rounded-[24px] p-8 md:p-10 transition-all duration-[300ms] ease-out hover:-translate-y-1 hover:border-gold-primary/50 hover:bg-[#151515] h-full shadow-lg hover:shadow-xl"
              >
