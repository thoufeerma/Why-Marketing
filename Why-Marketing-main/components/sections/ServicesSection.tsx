...
function BentoCard({ 
  ...
  return (
    <motion.div
      ...
      className={cn(
        "group relative flex flex-col justify-start overflow-hidden rounded-[28px] bg-[#111111] p-8 md:p-10 border transition-colors duration-[250ms] ease-out cursor-pointer shadow-none h-fit",
